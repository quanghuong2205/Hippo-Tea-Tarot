...
const JWT = {
    ACCESS_TOKEN_ALGORITHM:
        process.env.JWT_ACCESS_TOKEN_ALGORITHM,
    REFRESH_TOKEN_ALGORITHM:
        process.env.JWT_REFRESH_TOKEN_ALGORITHM,
...
class JWTServices {
    ...
    static async signTokenPair({
        ...
        /* Sign access token */
        const accessToken =
            await JWTServices.signAccessToken({
                publicKey,
                payload,
            });
        ...
        /* Sign refresh token */
        const refreshToken =
            await JWTServices.signRefreshToken({
                privateKey,
                payload,
            });
